...
import {
  require_jsx_runtime
} from "./chunk-PBJNJRUB.js";
import {
  require_react_dom
} from "./chunk-4ARTCBDG.js";
import {
  require_react
} from "./chunk-FKIIYCK3.js";
import {
  __commonJS,
  __toESM
...
var reconnectEdge = (oldEdge, newConnection, edges, options = { shouldReplaceId: true }) => {
  ...
  if (!foundEdge) {
    (_b = options.onError) == null ? void 0 : _b.call(options, "007", errorMessages["error007"](oldEdgeId));
    return edges;
  }
  const edgeIdGenerator = options.getEdgeId || getEdgeId;
  const edge = {
...
function MiniMapComponent({
  ...
  const nodeClickHandler = (0, import_react2.useCallback)((event, nodeId) => {
    ...
    onNodeClick == null ? void 0 : onNodeClick(event, node);
  }, [onNodeClick]);
